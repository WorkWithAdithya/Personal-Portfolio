...
document.addEventListener('visibilitychange', function () {
  if (document.visibilityState === 'visible') {
    document.title = 'Adithya BS Portfolio';
    $('#favicon').attr('href', 'assests/images/PP.png');
  } else {
    document.title = 'You are out of site';
  }
});

// <!-- typed js effect starts -->
var typed = new Typed('.typing-text', {
  strings: ['Front-end Development', 'Web Development', 'Software Development'],
  loop: true,
  typeSpeed: 50,
  backSpeed: 25,
  backDelay: 500,
